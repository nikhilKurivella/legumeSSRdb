                ...
                <div class="card-body">
                      ...
                      <div class="form-group">
                         <div class="form-check">
                               <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="region" id="optionsRadios1" value="chType" checked>
                                Genomic
                                </label>
                            ...
                            <div class="dropdown">
                              <button class="btn btn-primary btn-lg dropdown-toggle" type="button" id="dropdownMenuSizeButton1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                <span id="typeName">Chromosomes (Multi select)</span>&nbsp;
                              </button>
                              <div class="dropdown-menu" id="chTypeDropdown" aria-labelledby="dropdownMenuSizeButton1" style="overflow-y: scroll; max-height: 200px;">
                                <ul class="ch-dropdown" aria-lablledby="dropdownMenuSizeButton1" >
                              <?php
                  ...
                  <div class="col-md-7">
                    <div class="form-check">
                        ...
                        <input type="text" class="form-control mb-2 mr-sm-2" style="width: 90%" id="repeatMotifText" placeholder="enter text">
                       </div>
                    </div>
                  </div>
                  </div>
   ...
   // Search button
        $("#searchButton").click(function(){
            ...
            console.log(blastDBPath);
             ...
             // Validations
            if($('input[name=region]:checked').val() == "chType" && chTypeDropdownVal == null) {

            ...
            <div class="row">
              ...
              <div class="card">
                <div class="card-body">
                   ...
                   <img id="genomeImage" src="assets/images/genomes/soybean.jpg" style="width: 430px; height: 250px; padding-bottom: 20px">
                <div>
            <span id="genomeDescription" >Soybean is the predominant oil-seed legume; it produces a high-protein meal and has many industrial uses.</span>
          </div>
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2">
                         ...
                         <div class="form-check">
                               <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="region" id="optionsRadios1" value="both" >
                                Both
                                </label>
  ...
  $(document).ready(function(){
    ...
    //advance search toggle
         $("#advancedSearchToggle").change(function() {
            if(this.checked) {
               $("#soft-limit").prop("disabled", false);
   ...
   // Search button
        ...
        $("#searchButton").click(function(){
            ...
            console.log("here inside search script");
            var validFlag = false;
            ...
            if(type == 'Scaffold'  && chTypeDropdownVal == null) {
              ...
              console.log("9");
               ...
               if($('input[name=region]:checked').val() == "non-genic"){
              console.log("2");
                nonGenicActive = true;
            ...
            else if($('input[name=region]:checked').val() == "both"){
              console.log("3");
                genicNonGenicActive = true;  
            }
               validFlag = true;
            }
            if(validFlag) {
              ...
              formdata.append("genicNonGenicActive", genicNonGenicActive);
              formdata.append("motifMinFreq", motifMinFreq);
              formdata.append("motifMaxFreq" , motifMaxFreq);
              formdata.append("genomeName" , genomeName);
              
              console.log("YYYYYYYYYYYYYYY"+genicActive);
              var geneLocation = "ngenic";
                if (genicActive) {
                  console.log("Aa gaya");
                  geneLocation = "genic";
                }
                else if (nonGenicActive) {
                  console.log("Aa gaya");
                  geneLocation = "non_genic";
                }
                else if (genicNonGenicActive) {
                  geneLocation = "both";
                }
              console.log("Final"+geneLocation);
              var request = new XMLHttpRequest();
              request.open("POST", "fetchGenomeInfo.php", true);
              request.onload = function () {
                        if (request.readyState === request.DONE) {
                            if (request.status === 200) {
                                var resultUrl = "results.php?f="+result_timestamp+"&chtype="+type+"&motifType="+motifDropdownVal+"&gname="+Name+"&chstart="+chLocationStartVal+"&chEnd="+chLocationEndVal+"&copyStart="+copyNumberStartVal+"&copyEnd="+copyNumberEndVal+"&geneLocation="+geneLocation+"&tableName="+tableName;
